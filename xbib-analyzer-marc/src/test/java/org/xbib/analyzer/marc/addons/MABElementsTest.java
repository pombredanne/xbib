...
public class MABElementsTest {
    ...
    public void testSetupOfElements() throws Exception {
        ...
        KeyValueStreamListener listener = new MABElementMapper("mab").addBuilder(builder);                
    ...
    public void testZDBElements() throws Exception {
        InputStream in =  InputStreamService.getInputStream(URI.create("file:src/test/resources/1217zdbtit.dat"));
