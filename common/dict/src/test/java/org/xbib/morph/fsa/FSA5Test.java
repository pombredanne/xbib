...
public final class FSA5Test {
    ...
    public void testVersion5() throws IOException {
        final FSA fsa = FSAUtils.read(this.getClass().getResourceAsStream("abc.fsa"));
    ...
    public void testVersion5WithNumbers() throws IOException {
        final FSA fsa = FSAUtils.read(this.getClass().getResourceAsStream("abc-numbers.fsa"));
    ...
    public void testArcsAndNodes() throws IOException {
        final FSA fsa1 = FSAUtils.read(this.getClass().getResourceAsStream(
                "abc.fsa"));
        final FSA fsa2 = FSAUtils.read(this.getClass().getResourceAsStream(
                "abc-numbers.fsa"));
    ...
    public void testNumbers() throws IOException {
        final FSA5 fsa = FSAUtils.read(this.getClass().getResourceAsStream("abc-numbers.fsa"));
