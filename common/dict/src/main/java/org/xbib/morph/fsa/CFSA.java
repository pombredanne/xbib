...
public final class CFSA extends FSA {
    ...
    public CFSA setArcs(byte[] arcs) {
        this.arcs = arcs;
        return this;
    }

    public CFSA setNodeDataLength(int nodeDataLength) {
        this.nodeDataLength = nodeDataLength;
        return this;
    }

    public CFSA setLabelMapping(byte[] labelMapping) {
        this.labelMapping = labelMapping;
        return this;
    }

    public CFSA setGotoLength(int gtl) {
        this.gtl = gtl;
        return this;
    }

    public CFSA setFlags(Set<FSAFlags> flags) {
        this.flags = flags;
        return this;
    }
