...
public class NShortestPaths {
    ...
    public static Fst get(Fst fst, int n, boolean determinize) {
        ...
        res.setInputSymbols(fstdet.getInputSymbols());
        res.setOutputSymbols(fstdet.getOutputSymbols());
            ...
            if (previous.get(pair) == null) {
                ...
                for (int j = 0; j < numArcs; j++) {
                    ...
                    if (a.getNextState().getId() == p.getId()) {
                        previouState.addArc(new Arc(a.getInputLabel(), a
                                .getOutputLabel(), a.getWeight(), s));
                    }
                }
            }
