...
public class AuthenticatingSMTPClient extends SMTPSClient
{
     ...
     *
     * @param method the method to use, one of the {@link org.apache.commons.net.smtp.AuthenticatingSMTPClient.AUTH_METHOD} enum values
     ...
     * @exception java.io.IOException  If an I/O error occurs while either sending a
     *      command to the server or receiving a reply from the server.
     * @exception java.security.NoSuchAlgorithmException If the CRAM hash algorithm
     *      cannot be instantiated by the Java runtime system.
     * @exception java.security.InvalidKeyException If the CRAM hash algorithm
     *      failed to use the given password.
     * @exception java.security.spec.InvalidKeySpecException If the CRAM hash algorithm
     *      failed to use the given password.
     ***/
