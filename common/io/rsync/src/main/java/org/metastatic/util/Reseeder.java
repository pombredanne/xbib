...
public final class Reseeder {
     ...
     *                 reseeding.
     * @throws IllegalArgumentException If the policy is not
     ...
     * @throws NullPointerException     If <code>prng</code> is
     *                                  <code>null</code>.
     */
    public Reseeder(int policy, int seedSize, long timeout, SecureRandom prng)
     ...
     * and puts {@link System#currentTimeMillis()} into {@link
     * #lastReseed}.
     */
    private void reseed() {
