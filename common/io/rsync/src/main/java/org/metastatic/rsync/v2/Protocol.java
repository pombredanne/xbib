            ...
            case STATE_RECEIVE_EXCLUDE:
                ...
                if (options.am_sender) {
                    ...
                    tool = new NonblockingFileList(options, module.path, argv,
                            remoteVersion, FLIST_SEND_FILES);
        ...
        switch (outState) {
            ...
            case SETUP_WRITE_DONE:
                ...
                try {
                    ...
                    duplex.putString(MultiplexedIO.FERROR, "server configuration error\n");
                    connected = false;
                    module.connections--;
                    return;
                }
                ...
                if (stats_module) {
                    duplex.putString(MultiplexedIO.FINFO,
                ...
                if (!options.am_sender) {
                    ...
                    if (options.delete_mode && !options.delete_excluded) {
                        ...
                        tool = new NonblockingFileList(options, module.path, argv,
                                remoteVersion, FLIST_RECEIVE_FILES);
                        tool.setBuffers(duplex, inBuffer);
                        state = STATE_RECEIVE_FLIST;
                    }
                } else {
