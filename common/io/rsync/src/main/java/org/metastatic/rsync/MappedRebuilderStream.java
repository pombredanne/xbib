...
/**
 * A version of {@link org.metastatic.rsync.RebuilderStream} that maps large files to memory
...
public class MappedRebuilderStream extends RebuilderStream {
     ...
     * and a maximum map size of {@link Integer#MAX_VALUE}.
     */
