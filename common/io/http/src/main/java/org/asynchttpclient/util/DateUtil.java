...
public class DateUtil {
     ...
     * @throws org.asynchttpclient.util.DateUtil.DateParseException if the value could not be parsed using any of the
     ...
     * @return the parsed date
     * @throws org.asynchttpclient.util.DateUtil.DateParseException if none of the dataFormats could parse the dateValue
     */
