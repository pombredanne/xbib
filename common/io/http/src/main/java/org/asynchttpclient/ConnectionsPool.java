...
/**
 * An interface used by an {@link org.asynchttpclient.AsyncHttpProvider} for caching http connections.
 */
public interface ConnectionsPool<U, V> {
     ...
     * Calling this method is equivalent of checking the returned value of {@link org.asynchttpclient.ConnectionsPool#offer(Object, Object)}
     *
