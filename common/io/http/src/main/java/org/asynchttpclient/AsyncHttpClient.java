 ...
 * </pre></blockquote
 * From any HTTP content sub classes, you can asynchronously process the response status,headers and body and decide when to
 * stop the processing the response by throwing a new {link ResponseComplete} at any moment.
 * <p/>
 * This class can also be used without the need of {@link org.asynchttpclient.AsyncHandler}</p>
 * <blockquote><pre>
 *      AsyncHttpClient c = new AsyncHttpClient();
...
public class AsyncHttpClient implements Closeable {
     ...
     *
     * @param request {@link Request}
     * @return a {@link java.util.concurrent.Future} of type Response
     * @throws java.io.IOException
     */
    ...
    /**
     * Configure and execute the associated {@link org.asynchttpclient.filter.RequestFilter}. This class may decorate the {@link Request} and {@link org.asynchttpclient.AsyncHandler}
     *
     * @param fc {@link org.asynchttpclient.filter.FilterContext}
     * @return {@link org.asynchttpclient.filter.FilterContext}
     */
