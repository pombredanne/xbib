...
/**
 * A {@link org.asynchttpclient.resumable.ResumableListener} which use a {@link java.io.RandomAccessFile} for storing the received bytes.
 */
public class ResumableRandomAccessFileListener implements ResumableListener {
    ...
    /**
     * This method uses the last valid bytes written on disk to position a {@link java.io.RandomAccessFile}, allowing
