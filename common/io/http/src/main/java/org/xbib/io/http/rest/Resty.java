...
import org.xbib.io.http.rest.auth.RestyAuthenticator;
import org.xbib.io.http.rest.mime.MultipartContent;
...
public class Resty {
    ...
    private static RestyAuthenticator rath;
     ...
     * Use {@link #setOptions(Resty.Option...)} to change options afterwards.
     */
     ...
     * @param aLogin
     * @param charArray
     * @see Resty#authenticate(java.net.URI, String, char[])
     */
     ...
     * @see Resty#json(java.net.URI) for more docs
     */
     ...
     *
     * @param anUri          the URI to visit
     * @param requestContent the content to POST to the URI
     * @return
     * @throws java.io.IOException if uri is wrong or no connection could be made or for 10 zillion other reasons
     */
     ...
     * @throws java.io.IOException if content type sent is not a plain text, if the connection could not be made and gazillion other reasons
     */
     ...
     *
     * @param string - the string to use as URI
     * @see Resty#xml(java.net.URI) for more docs
     */
     ...
     * @param con           the URLConnection used to get the data
     * @param resourceClass the resource class to instantiate
     ...
     *
     * @param somePlainText the plain text to send
     * @return the content to send
     */
