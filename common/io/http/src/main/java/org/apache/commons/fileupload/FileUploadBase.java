 ...
 * #parseRequest(UploadContext)} to acquire a list of {@link
...
public abstract class FileUploadBase {
     ...
     * @throws FileUploadException if there are problems reading/parsing
     *                             the request or storing files.
     * @throws java.io.IOException An I/O error occurred. This may be a network
     *   error while communicating with the client or a problem while
     *   storing the uploaded content.
     */
    public FileItemIterator getItemIterator(UploadContext ctx)
     ...
     * {@link org.apache.commons.fileupload.FileUploadBase#getItemIterator(UploadContext)}.
     */
    private class FileItemIteratorImpl implements FileItemIterator {

        /**
         * Default implementation of {@link org.apache.commons.fileupload.FileItemStream}.
         */
         ...
         * @throws java.io.IOException An I/O error occurred.
         */
        FileItemIteratorImpl(UploadContext ctx)
                throws FileUploadException, IOException {
            if (ctx == null) {
     ...
     * {@link FileUploadException} in an {@link java.io.IOException}.
     */
