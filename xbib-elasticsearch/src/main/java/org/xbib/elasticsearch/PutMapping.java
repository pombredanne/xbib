 ...
 * 
 */
public class PutMapping extends AbstractOperation 
    ...
    public void write(ElasticsearchSession session, StringData mapping) throws IOException {
        StringData json = mapping != null ?  mapping : getMapping();
    ...
    @Override
    public void create(ElasticsearchSession session, Identifiable identifier, StringData mapping) throws IOException {
