...
public class ElasticsearchMockDAO implements ElasticsearchInterface {

    private final static Logger logger = LoggerFactory.getLogger(ElasticsearchMockDAO.class.getName());
    ...
    public ElasticsearchMockDAO() {
    }

    public ElasticsearchMockDAO settings(Settings settings) {
        this.settings = settings;
        return this;
    }

    public ElasticsearchMockDAO newClient(boolean force) {
        return newClient(findURI(), force);
    }

    public ElasticsearchMockDAO newClient(URI uri, boolean force) {
    ...
    public ElasticsearchMockDAO newRequest() {
        // for CQL 
        generator = new ESGenerator();
        return this;
    }

    public ElasticsearchMockDAO setIndex(String index) {
    ...
    public ElasticsearchMockDAO setType(String type) {
    ...
    public ElasticsearchMockDAO setFrom(int from) {
        searchRequestBuilder.setFrom(from);
        generator.setFrom(from);
        return this;
    }

    public ElasticsearchMockDAO setSize(int size) {
        searchRequestBuilder.setSize(size);
        generator.setSize(size);
        return this;
    }

    public ElasticsearchMockDAO filter(String filter) {
        searchRequestBuilder.setFilter(filter);
        return this;
    }

    public ElasticsearchMockDAO facets(String facets) {
        searchRequestBuilder.setFacets(facets.getBytes());
        return this;
    }

    public ElasticsearchMockDAO timeout(TimeValue timeout) {
        searchRequestBuilder.setTimeout(timeout);
        return this;
    }

    public ElasticsearchMockDAO logger(Logger queryLogger) {
        this.queryLogger = queryLogger;
        return this;
    }

    public ElasticsearchMockDAO query(String query) {
        this.originalQuery = this.query;
        this.query = query == null || query.trim().length() == 0 ? "{\"query\":{\"match_all\":{}}}" : query;
        return this;
    }

    public ElasticsearchMockDAO fromCQL(String query) {
        if (generator == null) {
    ...
    public ElasticsearchMockDAO execute() throws IOException {
    ...
    public ElasticsearchMockDAO outputFormat(OutputFormat format) {
        this.format = format;
        return this;
    }

    public ElasticsearchMockDAO toJson(OutputStream out) throws IOException {
        if (out == null) {
            return this;
        }
    ...
    public ElasticsearchMockDAO xmlEventConsumer(XMLEventConsumer consumer) throws IOException {
        this.consumer = consumer;
        return this;

    }

    public ElasticsearchMockDAO styleWith(StylesheetTransformer transformer, String stylesheets, OutputStream target) throws IOException {
    ...
    public ElasticsearchMockDAO dispatch() throws IOException {
        return dispatchTo(null);
    }

    public ElasticsearchMockDAO dispatchTo(OutputProcessor processor) throws IOException {
        if (searchResponse == null) {
            if (processor != null) {
     ...
     * @throws IOException
     */
    public ElasticsearchMockDAO get(String index, String type, String id, OutputProcessor processor) throws IOException {
        if (format == null) {
            return this;
        }
        long t0 = System.currentTimeMillis();
    ...
    protected static URI findURI() {
        ...
        try {
            ...
            try (InputStream in = ElasticsearchMockDAO.class.getResource("/org/xbib/elasticsearch/cluster.properties").openStream()) {
                p.load(in);
