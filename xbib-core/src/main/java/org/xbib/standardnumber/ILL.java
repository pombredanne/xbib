...
public class ILL implements StandardNumber {
    ...
    public int compareTo(Object obj) {
        return value != null && obj instanceof ILL ? value.compareTo(((ILL) obj).getValue()) : -1;
    }
    ...
    private String purify(String s) {
        ...
        return m.find() ? s.substring(m.start(), m.end()) : "";
    }

    private void parse() {
        this.value = lexicalForm;
        // segment
