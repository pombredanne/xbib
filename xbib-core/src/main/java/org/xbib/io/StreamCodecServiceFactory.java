...
public class StreamCodecServiceFactory {

    private final static Map<String, StreamCodec> codecs = new WeakHashMap();
    private final static StreamCodecServiceFactory instance = new StreamCodecServiceFactory();

    private StreamCodecServiceFactory() {
        ...
        while (iterator.hasNext()) {
            ...
            if (!codecs.containsKey(codec.getSuffix())) {
                codecs.put(codec.getSuffix(), codec);
            }
        }
    }

    public static StreamCodecServiceFactory getInstance() {
        return instance;
    }
