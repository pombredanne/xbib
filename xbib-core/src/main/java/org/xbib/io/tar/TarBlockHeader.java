 ...
 */
public class TarBlockHeader extends TarRecord {

    public static final int FILE_NAME_SIZE = 100;

    public static final String CHECKSUM_BLANKS = "        ";

    public static final String MAGIC = "ustar";

    //Link Flag Constants
    public static final char LF_OLDNORMAL = '\0';

    public static final char LF_NORMAL = '0';

    public static final char LF_LINK = '1';

    public static final char LF_SYMLINK = '2';

    public static final char LF_CHAR = '3';

    public static final char LF_BLOCK = '4';

    public static final char LF_DIR = '5';

    public static final char LF_FIFO = '6';

    public static final char LF_CONTIGUOUS = '7';
