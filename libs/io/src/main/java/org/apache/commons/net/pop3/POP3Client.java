...
public class POP3Client extends POP3
{
     ...
     * @exception java.io.IOException If a network I/O error occurs in the process of
     ...
     * @exception java.io.IOException If a network I/O error occurs in the process of
     *            logging in.
     * @exception java.security.NoSuchAlgorithmException If the MD5 encryption algorithm
     ...
     * @exception java.io.IOException If a network I/O error occurs in the process
     *           of logging out.
     ***/
