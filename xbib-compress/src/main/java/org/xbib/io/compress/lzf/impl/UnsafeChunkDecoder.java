package org.xbib.io.compress.lzf.impl;
...
//    private static final long SHORT_ARRAY_STRIDE = unsafe.arrayIndexScale(short[].class);
    ...
    private int copyOverlappingShort(final byte[] out, int outPos, final int offset, int len)
    {
    ...
    private static int copyOverlappingLong(final byte[] out, int outPos, final int offset, int len)
    {
    ...
    private static void copyUpTo32(byte[] in, int inputIndex, byte[] out, int outputIndex, int lengthMinusOne)
    {
