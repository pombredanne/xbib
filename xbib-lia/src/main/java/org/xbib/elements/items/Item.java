...
public class Item implements Node {
    ...
    private DeliveryMethod preferredDelivery;
    private TransportMethod preferredTransport;
    ...
    public Item delivery(DeliveryMethod method) {
        this.preferredDelivery = method;
        return this;
    }

    public Item transport(TransportMethod method) {
        this.preferredTransport = method;
        return this;
    }
