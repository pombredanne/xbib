...
<div class="container">
                <div class="page-header">
                    <img alt="Logo" src="img/objectstorage-logo.png"/>
                    <h1>Object Storage</h1>
                </div>
                <blockquote>
                    <p>File Upload widget with multiple file selection, drag'n'drop support, progress bars and preview images for jQuery.<br />
                        Supports cross-domain, chunked and resumable file uploads and client-side image resizing.<br />
                    </p>
                </blockquote>
    <br>
    <!-- The file upload form used as target for the file upload widget -->
    <form id="fileupload" action="${pageContext.request.contextPath}/api/v1/default/item/NEW>" 
