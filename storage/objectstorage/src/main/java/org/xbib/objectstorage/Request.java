...
public interface Request {
    ...
    Request setUser(String user);

    String getUser();

    Request setContainer(String container);

    String getContainer();

    Request setItem(String item);

    String getItem();

    UserAttributes getUserAttributes() throws IOException;

    Request addStringParameter(String key, String value);

    Request addLongParameter(String key, Long value);

    Request addDateParameter(String key, Date value);
