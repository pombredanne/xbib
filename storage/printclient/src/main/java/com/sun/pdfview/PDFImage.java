...
public class PDFImage {
    ...
    public static PDFImage createImage(PDFObject obj, Map resources)
        ...
        if (image.isImageMask()) {
            ...
            // commented out, will lead to exceptions and loading ICC profiles
            //PDFColorSpace cs = PDFColorSpace.getColorSpace(csObj, resources);
            
            // hack to get fixed gray color space
            PDFColorSpace cs = new PDFColorSpace(ColorSpace.getInstance(ColorSpace.CS_GRAY));
