...
public class JXLoginDialog extends JDialog {
    ...
    public JXLoginDialog(LoginService service, PasswordStore ps, UserNameStore us) {
        this(new JXLoginPanel(service, ps, us));
    }

    public JXLoginDialog(JXLoginPanel panel) {
        loginPanel = panel;
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        banner.setImage(createLoginBanner(Color.WHITE, Color.LIGHT_GRAY, Color.DARK_GRAY));
...
//    }
    ...
    private BufferedImage createLoginBanner(Color foreground, Color lightBackground, Color darkBackground) {
        ...
        g2.setColor(darkBackground
                //UIManager.getColor("JXTitledPanel.title.darkBackground")
                );
        g2.fillRect(0, 0, w, h);
        ...
        GradientPaint gp = new GradientPaint(0, h, 
                ...
                0, 0, 
                lightBackground
                //UIManager.getColor("JXTitledPanel.title.lightBackground")
        );
        g2.setPaint(gp);
        g2.fill(curveShape);
        ...
        g2.setColor(foreground
                //UIManager.getColor("JXTitledPanel.title.foreground")
                );
