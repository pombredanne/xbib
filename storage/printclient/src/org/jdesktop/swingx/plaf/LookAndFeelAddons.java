/*
 * $Id: LookAndFeelAddons.java,v 1.13 2005/10/10 18:02:20 rbair Exp $
 *
 ...
 * {@link #getBestMatchAddonClassName()}. <p> The default addon can be
 * configured using the
 * <code>swing.addon</code> system property as follow: <ul> <li>on the command
 * line,
 * <code>java -Dswing.addon=ADDONCLASSNAME ...</code></li> <li>at runtime and
 * before using the library components
 * <code>System.getProperties().put("swing.addon", ADDONCLASSNAME);</code> </li>
 * </ul> <p> The addon can also be installed directly by calling the
...
public class LookAndFeelAddons {
     ...
     * <code>UIManager.getLookAndFeel()</code>), this method returns the name of
     * the closest
     * <code>LookAndFeelAddons</code> to use.
     *
     ...
     * reloaded. This means component.updateUI will fail because it will not
     * find its UI.
     *
     * This method ensures LookAndFeelAddons get re-initialized if needed. It
     * must be called in every component updateUI methods.
     */
    ...
    /**
     * @return true if the addon will be automatically change to match the
