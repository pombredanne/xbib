...
public class ConcurrentBulkRequest extends BulkRequest implements ActionRequest {

    private static final int REQUEST_OVERHEAD = 50;
    private final Queue<ActionRequest> requests = Queues.newConcurrentLinkedQueue();
    ...
    /**
     * The list of optional payloads associated with requests in the same order
     * as the requests. Note, elements within it might be null if no payload has
     * been provided.
     * <p/>
     * Note, if no payloads have been provided, this method will return null (as
     * to conserve memory overhead).
     */
    @Nullable
    @Override
    ...
    @Override
    public ConcurrentBulkRequest listenerThreaded(boolean listenerThreaded) {
