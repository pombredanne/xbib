...
public class OAI {
    ...
    private final static Logger logger = LoggerFactory.getLogger(OAI.class.getName());
    ...
    public static void main(String[] args) throws Exception {
        ...
        new OAI(client, output).execute(request).close();
    ...
    OAI(OAIClient client, String output) throws IOException {
        this.client = client;
    ...
    private OAI execute(ListRecordsRequest request) throws Exception {
