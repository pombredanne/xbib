...
public class SerialsDBConverter {
    ...
    private final static Logger logger = LoggerFactory.getLogger(SerialsDBConverter.class.getName());
    ...
    public SerialsDBConverter(Reader input, String outputFile) throws IOException {
