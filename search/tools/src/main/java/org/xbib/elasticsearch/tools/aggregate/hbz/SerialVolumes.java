 ...
 */
package org.xbib.elasticsearch.tools.aggregate.hbz;
...
public class SerialVolumes {
    ...
    private SearchClient support;
    private String index;
    private String type;

    public SerialVolumes(SearchClient support, String index, String type) {
    ...
    public static void main(String[] args) {
        try {
            ...
            SearchClient es = new SearchClient()
                    .newClient(esURI);
