...
/**
 * A Builder for building XContent from a resource, with Kibana3 format
 *
 * @param <C>
 * @param <R>
 */
public class KibanaContentBuilder<C extends ResourceContext, R extends Resource>
    ...
    public KibanaContentBuilder timestamp(Date timestamp) {
        this.timestamp = timestamp;
        return this;
    }

    public KibanaContentBuilder message(String message) {
        this.message = message;
        return this;
    }

    public KibanaContentBuilder source(String source) {
        this.source = source;
        return this;
    }

    public KibanaContentBuilder sourceHost(String sourceHost) {
        this.sourceHost = sourceHost;
        return this;
    }

    public KibanaContentBuilder sourcePath(String sorucePath) {
        this.sourcePath = sourcePath;
        return this;
    }

    public KibanaContentBuilder type(String... type) {
        this.type = type;
        return this;
    }

    public KibanaContentBuilder tags(String... tags) {
        this.tags = tags;
        return this;
    }
