...
public class BuilderTest<S extends Identifier, P extends Property, O extends Node>
    extends Assert {

    private final Logger logger = Loggers.getLogger(BuilderTest.class);
    ...
    public void testSimpleBuilder() throws Exception {
        ...
        String result = builder.build(context, resource);
