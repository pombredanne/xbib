...
public class DublinCoreElementMapper
    ...
    public DublinCoreElementMapper(String format) {
        super("/org/xbib/elements/", format);
        pipelines(Runtime.getRuntime().availableProcessors());
    }

    public DublinCoreElementMapper start() {
        start(new DublinCoreBuilderFactory());
        return this;
    }


    public DublinCoreElementMapper start(final DublinCoreBuilder builder) {
