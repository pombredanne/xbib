...
public class ElementMapBuilder<K> {

    public static int DEFAULT_BUFFER_SIZE = 8192;
    private final static Logger logger = LoggerFactory.getLogger(ElementMapBuilder.class.getName());
    private final static Map<String, Map> maps = new HashMap();

    public ElementMapBuilder() {
    }
    ...
    public static InputStream loadResource(ClassLoader cl, String resourcePath) {
        ...
        if (in == null) {
            // load from same path as class ElementMapBuilder
            in = ElementMapBuilder.class.getResourceAsStream(resourcePath);
            if (in == null) {
    ...
    public static Class loadClass(ClassLoader cl, String className) {
        ...
        try {
            ...
            try {
                // load from same class loader as class ElementMapBuilder
