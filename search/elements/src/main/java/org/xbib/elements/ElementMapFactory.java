...
public class ElementMapFactory<K> {
    ...
    public synchronized static Map<String, Element> getElementMap(ClassLoader cl, String path, String format)
            throws IOException, ClassNotFoundException, InstantiationException, IllegalAccessException,
            NoSuchMethodException, IllegalArgumentException, InvocationTargetException {
    ...
    public static InputStream loadResource(ClassLoader cl, String resourcePath) {
        ...
        if (in == null) {
            // load from same path as class ElementMapFactory
            in = ElementMapFactory.class.getResourceAsStream(resourcePath);
            if (in == null) {
    ...
    public static Class loadClass(ClassLoader cl, String className) {
        ...
        try {
            ...
            try {
                // load from same class loader as class ElementMapFactory
