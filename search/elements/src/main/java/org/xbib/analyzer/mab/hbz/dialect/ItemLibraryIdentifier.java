...
public class ItemLibraryIdentifier extends MABElement {
    ...
    @Override
    public ItemLibraryIdentifier build(MABElementBuilder b, FieldCollection key, String value) {
        boolean servicecreated = false;
        for (Field f : key) {
            switch (f.subfieldId()) {
                case "a":
                    resolveIdentifier(b, f.data());
                    break;
                case "e":
                    createItemService(b, f.data());
                    servicecreated = true;
                    break;
            }
        }
    ...
    private String resolveIdentifier(MABElementBuilder b, String value) {
    ...
    private void createISIL(MABElementBuilder b, String isil, String provider) {
    ...
    private void createItemService(MABElementBuilder b, String itemStatus) {
