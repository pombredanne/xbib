...
public class SequentialCharStream extends Reader implements CharStream {
     ...
     * @throws IOException If an error occurs attempting mark this
     * BufferedReader.
     ...
     * @throws IOException If the BufferedReader is already closed or some other
     * IO error occurs.
     */
    @Override
     ...
     *
     * @throws IOException If a problem occurred, the receiver does not support
