...
public class PropertiesZClient extends DefaultZClient implements ZClient, ZConstants {

    private Properties properties;

    public PropertiesZClient(ZSession session, Properties properties) {
        super(session);
    ...
    public String getEncoding() {
        return properties.getProperty(ENCODING_PROPERTY, "ANSEL");
    }

    @Override
    public String getFormat() {
        return properties.getProperty(FORMAT_PROPERTY, "MARC21");
    }

    @Override
    public String getType() {
        return properties.getProperty(TYPE_PROPERTY, "Bibliographic");
    }
}
