...
public interface ZConstants {
    ...
    String PREFERRED_RECORD_SYNTAX_PROPERTY = "preferredrecordsyntax";

    String RESULT_SET_NAME_PROPERTY = "resultsetname";

    String ELEMENT_SET_NAME_PROPERTY = "elementsetname";
