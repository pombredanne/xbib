...
import org.xbib.io.iso23950.pqf.RPNGenerator;
import z3950.v3.RPNQuery;

public class PQFSearchOperation extends AbstractSearchOperation {

    public PQFSearchOperation(List<String> databases, String resultSetName) {
