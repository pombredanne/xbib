...
/**
 * Class for representing a <code>Units</code> from <code>RecordSyntax-explain</code>
 * <p/>
 * <pre>
 * Units ::=
 * SEQUENCE {
 ...
 *   unit [2] EXPLICIT StringOrNumeric
 * }
 * </pre>
 *
 */
public final class Units extends ASN1Any {

    /**
     * Default constructor for a Units.
     */
    ...
    /**
     * Constructor for a Units from a BER encoding.
     * <p/>
     *
    ...
    public Units(BEREncoding ber, boolean check_tag)
    ...
    ber_decode(BEREncoding ber, boolean check_tag)
            throws ASN1Exception {
        // Units should be encoded by a constructed BER
        ...
        if (num_parts <= part) {
            ...
            throw new ASN1Exception("Zebulun Units: incomplete");
        }
        ...
        // Decoding: unit [2] EXPLICIT StringOrNumeric
        ...
        if (p.tag_get() != 2 ||
                p.tag_type_get() != BEREncoding.CONTEXT_SPECIFIC_TAG) {
            throw new ASN1EncodingException
                    ("Zebulun Units: bad tag in s_unit\n");
        }
        ...
        try {
            ...
            throw new ASN1EncodingException
                    ("Zebulun Units: bad BER encoding: s_unit tag bad\n");
        }
        ...
        if (part < num_parts) {
            throw new ASN1Exception("Zebulun Units: bad BER: extra data " + part + "/" + num_parts + " processed");
        }
    }

    /**
     * Returns a BER encoding of the Units.
     *
    ...
    /**
     * Returns a BER encoding of Units, implicitly tagged.
     *
    ...
    ber_encode(int tag_type, int tag)
        ...
        // Encoding s_unit: StringOrNumeric
