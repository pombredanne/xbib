...
public final class StringOrNumeric extends ASN1Any {
    ...
    /**
     * Default constructor for a StringOrNumeric.
     */
    ...
    public StringOrNumeric(BEREncoding ber, boolean check_tag)
    ...
    ber_decode(BEREncoding ber, boolean check_tag)
        ...
        throw new ASN1Exception("Zebulun StringOrNumeric: bad BER encoding: choice not matched");
    }
    ...
    ber_encode()
        ...
        if (c_numeric != null) {
            ...
            chosen = c_numeric.ber_encode(BEREncoding.CONTEXT_SPECIFIC_TAG, 2);
        }
    ...
    ber_encode(int tag_type, int tag)
        ...
        throw new ASN1EncodingException("Zebulun StringOrNumeric: cannot implicitly tag");
    }
