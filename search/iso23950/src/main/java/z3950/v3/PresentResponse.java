...
public final class PresentResponse extends ASN1Any {
    ...
    public PresentResponse(BEREncoding ber, boolean check_tag)
    ...
    ber_decode(BEREncoding ber, boolean check_tag)
        ...
        if (p.tag_get() != 24 ||
            ...
            throw new ASN1EncodingException
                    ("Zebulun PresentResponse: bad tag in s_numberOfRecordsReturned\n");
        }
        ...
        if (p.tag_get() != 25 ||
                p.tag_type_get() != BEREncoding.CONTEXT_SPECIFIC_TAG) {
            throw new ASN1EncodingException
                    ("Zebulun PresentResponse: bad tag in s_nextResultSetPosition\n");
        }
