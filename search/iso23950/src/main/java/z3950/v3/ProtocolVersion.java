...
public final class ProtocolVersion extends ASN1Any {
    ...
    public ProtocolVersion(BEREncoding ber, boolean check_tag)
        ...
        if (check_tag) {
            if (ber.tag_get() != 3 ||
                ...
                throw new ASN1EncodingException
                        ("Zebulun: ProtocolVersion: bad BER: tag=" + ber.tag_get() + " expected 3\n");
            }
        }
    ...
    ber_encode()
            throws ASN1Exception {
        return ber_encode(BEREncoding.CONTEXT_SPECIFIC_TAG, 3);
    }
