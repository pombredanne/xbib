...
public final class ResourceReportId extends ASN1Any {
    ...
    /**
     * Default constructor for a ResourceReportId.
     */

    public ResourceReportId() {
    }
    ...
    public ResourceReportId(BEREncoding ber, boolean check_tag)
    ...
    ber_decode(BEREncoding ber, boolean check_tag)
            throws ASN1Exception {
        value = new ASN1ObjectIdentifier(ber, check_tag);
    }
