...
public class FederatorRequest {
    ...
    public FederatorRequest(String id, ExecutorService service) {
        this.id = id;
    ...
    public FederatorRequest add(Action action) {
        actions.add(action);
        return this;
    }
     ...
     * @param listener
     */
    public FederatorRequest addListener(ResponseListener<Action> listener) {
     ...
     * @param listener
     */
    public FederatorRequest removeListener(ResponseListener<Action> listener) {
