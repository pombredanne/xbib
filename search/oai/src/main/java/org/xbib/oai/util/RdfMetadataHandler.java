...
public class RdfMetadataHandler extends MetadataHandler implements OAIConstants {
    ...
    private final Logger logger = LoggerFactory.getLogger(RdfMetadataHandler.class.getName());
    ...
    public AbstractXmlResourceHandler getHandler() {
        return handler;
    }
    ...
    /**
     * At the end of each OAI metadata, the resource context receives teh identifier from
