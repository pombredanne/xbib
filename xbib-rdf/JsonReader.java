...
public class JsonReader<S extends Resource<S, P, O>, P extends Property, O extends Literal<O>>
    ...
    public JsonReader() {
        this(SimpleNamespaceContext.getInstance(), null);
    }

    public JsonReader(QName root) {
        this(SimpleNamespaceContext.getInstance(), root);
    }

    public JsonReader(NamespaceContext context, QName root) {
    ...
    public JsonReader setIdentifier(URI identifier) {
        this.identifier = identifier;
        return this;
    }

    public JsonReader setIgnoreNamespaces(NamespaceContext ignore) {
        this.ignore = ignore;
        return this;
    }
    ...
    class Handler extends DefaultHandler {
        ...
        public void endDocument() throws SAXException {
            rootResource.setIdentifier(identifier);
            listener.newIdentifier(identifier);
            Iterator<Statement<S, P, O>> it = rootResource.iterator(true);
            while (it.hasNext()) {
        ...
        public void startElement(String nsURI, String localname, String qname, Attributes atts) throws SAXException {
            ...
            if (!stack.empty()) {
                ...
                P property = rootResource.createPredicate(uri);
