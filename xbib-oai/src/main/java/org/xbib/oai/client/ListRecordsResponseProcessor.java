...
public class ListRecordsResponseProcessor extends AbstractResponseProcessor {
    ...
    ListRecordsResponseProcessor(ListRecordsRequest request, ListRecordsResponse response, StylesheetTransformer transformer) {
    ...
    public ListRecordsResponseProcessor setMetadataReader(MetadataReader metadataReader) {
