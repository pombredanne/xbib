...
public interface OAIAdapter {
     ...
     * @throws OAIException 
     */
    void identify(IdentifyRequest request, IdentifyResponse response) throws OAIException;
     ...
     * @throws OAIException 
     */
    void listIdentifiers(ListIdentifiersRequest request, OAIResponse response) throws OAIException;
     ...
     * @throws OAIException 
     */
    void listMetadataFormats(ListMetadataFormatsRequest request, OAIResponse response) throws OAIException;
     ...
     * @throws OAIException 
     */
    void listSets(ListSetsRequest request, OAIResponse response) throws OAIException;
     ...
     * @throws OAIException 
     */
    void listRecords(ListRecordsRequest request, OAIResponse response) throws OAIException;
     ...
     * @throws OAIException 
     */
    void getRecord(GetRecordRequest request, OAIResponse response) throws OAIException;
