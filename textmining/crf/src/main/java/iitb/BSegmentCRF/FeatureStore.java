...
public class FeatureStore {
    ...
    /**
     * @param i
     * @param mi_YY edge features are constrainted to have "=s" and >=s" as the start and end boundaries
     */
    ...
    /**
     * @param ri_Y
     * @param openRi get all features with end boundary LE openRi.end and start boundary = openRi.start
     */
     ...
     * @param rightB
     * @param deltaRi
     * @param openDeltaRi Get all features which are applicable for segments with left boundary <= leftB and right boundary = rightB
     */
     ...
     * @param rightB
     * @param deltaRi
     * @param openDeltaRi Get all features with left boundary = leftB, right boundary open with a value <= rightB
     */
